  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast:
            "group toast group-[.toaster]:bg-white group-[.toaster]:text-black group-[.toaster]:border-[3px] group-[.toaster]:border-black group-[.toaster]:shadow-[var(--shadow-comic)] group-[.toaster]:rounded-[var(--radius-comic)] transition-all active:translate-x-[4px] active:translate-y-[4px] active:shadow-none",
          ...
          closeButton:
            "group-[.toast]:border-[2px] group-[.toast]:border-black group-[.toast]:bg-white group-[.toast]:text-black hover:group-[.toast]:bg-black/10 group-[.toast]:rounded-[var(--radius-comic)] active:translate-x-[2px] active:translate-y-[2px] transition",
        },
      }}
      {...props}
    />
